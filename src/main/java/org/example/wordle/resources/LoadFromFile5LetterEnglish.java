package org.example.wordle.resources;

import org.example.util.ReadFile;
...
public class LoadFromFile5LetterEnglish {
     ...
     private static final String FOLDER_PATH = "src/main/java/org/example/wordle/resources";
